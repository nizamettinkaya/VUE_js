...
export default {
  ...
  methods : {
    addTodo(){
      axios.post("https://vue-first-project-57401-default-rtdb.firebaseio.com/todoList.json", { text : this.todoText})
      .then(response => {
        this.todoList.push({
    ...
    deleteTodo(todoId){
      axios.delete("https://vue-first-project.firebaseio.com/todoList/" + todoId + ".json")
      .then(response => {
  ...
  created(){
      axios.get("https://vue-first-project.firebaseio.com/todoList.json")
      .then(response => {
